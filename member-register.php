    ...
    <div class="wrapper">
        ...
        <div class="member-register_content">
            <div class="profile">
                ...
                <p>ニックネーム:<input type="text" name="nickname" id="nickname"><span class="red">必須</span></p>
                <p>使える言語1:<input type="text" name="language1" id="language"><span class="red">必須</span></p>
